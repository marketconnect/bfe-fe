        ...
        <div className={view === 'users' ? 'px-4 md:px-8' : 'hidden'}>
          ...
          <div className="w-full">
            ...
            <div className="h-full flex flex-col relative">
              <div className="bg-white/95 backdrop-blur-sm border border-gray-200/60 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 mt-8 ring-1 ring-black/5 mx-3 md:mx-4 my-1.5">
                        ...
                        <div>
                          {user.isAdmin ? (
                            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-orange-100 to-amber-100 text-orange-800 border border-orange-200">
                              ...
                              {dictionary.adminPanel.users.badges.admin}
                            </span>
                          ) : (
